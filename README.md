...
- 관리자 기본 OFF 문항: 추진 배경, 참고자료/링크, 보유 데이터 및 연계 가능 자료, 기대효과 및 활용계획, 검토 단계, 수요 유형
- 새 문항: 해결되었으면 하는 점, 기술상담 희망, 실증사업 참여 의향
- ITSK 세계총회 전시투어: 기술수요 항목별 반복 문항이 아니라 개인정보 동의 전 1회 선택 영역으로 제공
- 현재 수정본 기본 노출 문항: 기관/단체명, 부서명, 담당자명, 연락처, 이메일, 기술수요명, 대분류, 소분류, 해결되었으면 하는 점, 필요 기술/서비스 내용, ITSK 세계총회 전시투어 참가 희망, 기타 의견
- 기타 입력: 기타 의견
...
응답은 Google Apps Script 웹앱을 통해 Google Sheet에 자동 적재됩니다. 한 응답자의 여러 기술수요는 한 행 안에서 `수요1_`, `수요2_` 형식으로 오른쪽 컬럼으로 확장됩니다.
...
현재 응답 데이터 헤더는 `시트1!A4`부터 동적으로 갱신됩니다. 5행부터 실제 응답이 쌓이며, 기술수요가 여러 건이면 같은 행에서 우측 컬럼으로 확장됩니다.
